...
const UUID = process.env.UUID || 'b7c67b70-8f86-4aff-90e0-e5090577846e';  
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'kr.stockhunter.qzz.io';           
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZDY1NWNiOTk2NzNlZTYzMDE4NDFkMmQyNmYxNTY5N2EiLCJ0IjoiMTBhNDQ4NjktNWIyMS00ZmE2LTllZDYtZmY3ZGY5OTZmYTM5IiwicyI6Ik9URmhOR0UzTWpJdFpEUXhOUzAwWm1GbExXRTFZall0T1RkaFlqZGtZekl6TVRkaSJ9';               
...
function getFilesForArchitecture(architecture) {
  if (architecture === 'arm') {
    return [
      { fileName: "web", fileUrl: "https://arm64.eooce.com/sbsh" },
      { fileName: "bot", fileUrl: "https://arm64.ssss.nyc.mn/bot" }
    ];
  } else {
    return [
      { fileName: "web", fileUrl: "https://amd64.eooce.com/sbsh" },
